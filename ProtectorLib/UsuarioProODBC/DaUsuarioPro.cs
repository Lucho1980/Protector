...
namespace UsuarioProODBC
{
    ...
    public class DaUsuarioPro
    {
        ...
        private UsuarioPEntity CrearEntidad(OdbcDataReader dr)
        {
            UsuarioPEntity entidad = new UsuarioPEntity();
        ...
        private void CrearParametros(OdbcCommand command, UsuarioPEntity entidad)
        {
        ...
        /// <param name="entidad">Objeto con los datos del empleado.</param>
        private void EjecutarComando(DaComun.TipoComandoEnum sqlCommandType, UsuarioPEntity entidad)
        {
        ...
        public UsuarioPEntity BuscarPorClavePrimaria(string legajo)
        {
            // Conexión a la base de datos
            OdbcConnection connection = null;
            // Comando a ejecutar en la base de datos.
        ...
        public List<UsuarioPEntity> Buscar(string legajo, string apellido, string nombre)
        {
            ...
            List<UsuarioPEntity> empleados = null;
            ...
            try
            {
                ...
                empleados = new List<UsuarioPEntity>();
